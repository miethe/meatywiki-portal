...
const STATUS_COLOURS: Record<WorkflowRunStatus, string> = {
  ...
  waiting_external: "bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-300",
  result_uploaded: "bg-violet-100 text-violet-800 dark:bg-violet-900/30 dark:text-violet-300",
};
  ...
  return (
    ...
    >
      ...
      {hasChildren && expanded && (
        ...
        >
          {node.children.map((child: SynthesisLineageNode) => (
            <LineageNode
