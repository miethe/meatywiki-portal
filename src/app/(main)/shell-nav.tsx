...
function StoriesIcon() {
  return (
    <svg aria-hidden="true" className="size-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 10h6M9 14h4" />
    </svg>
  );
}
  ...
  return [
    {
      ...
      items: [
        ...
        { label: "Stories", href: "/stories", ariaLabel: "Op story catalog", icon: <StoriesIcon /> },
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Review", href: "/review", ariaLabel: "Human review queue — low confidence and transcript pending artifacts", icon: <ReviewIcon /> },
        { label: "Cost Report", href: "/cost-report", ariaLabel: "LLM cost telemetry report", icon: <CostReportIcon /> },
      ],
    },
    {
      title: "Admin",
